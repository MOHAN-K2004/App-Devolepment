...
const ClientHome = () => {
  ...
  return (
    <>
      <ClientNavbar />
      <BiMessageRounded  style={{cursor:"pointer"}} onClick={gotochatbox} className="ClientHome-messageicon" />
      <div className="ClientHome">
        <div className="ClientHome-container1">
          <div className="ClientHome-container1-Left">
            ...
            <h1 className="ClientHome-container1-Left-text2">Start here</h1>
            ...
            <div className="ClientHome-container1-Left-icons">
              <h1 onClick={gotologin} style={{cursor:"Pointer"}}>Login</h1>
              <h6 onClick={gotosignup} style={{cursor:"Pointer"}}>Sign up</h6>
            </div>
